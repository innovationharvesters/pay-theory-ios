...
public let log = Logger(logHandlers: [createOSLogHandler(category: Logger.LOG_CATEGORY)])
 ...
 */
public class Logger {
  public static let LOG_SUBSYSTEM = "paytheory"
  public static let LOG_CATEGORY = "General"
